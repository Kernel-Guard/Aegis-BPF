...
| A.8.8 | Management of Technical Vulnerabilities | **Partial** | Policy hot-reload enables rapid response to CVE disclosures. Example: `deny_path /usr/lib/vulnerable-lib.so` applied in <50ms without restart. |
